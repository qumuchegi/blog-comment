...
export default function openGithubAuth(callbackUrl: string) {
  window.location.href = 
    `https://github.com/login/oauth/authorize?client_id=${github_auth_clientid}&redirect_uri=${'http://localhost:3000/api/githubLoginCallback?redirect_url=' + callbackUrl}`
}